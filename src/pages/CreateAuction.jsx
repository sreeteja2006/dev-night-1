...
import { useAuction } from '../store/auctionsStore';
...
const CreateAuction = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="bg-gradient-to-r from-purple-50 to-blue-100 min-h-screen py-6 flex flex-col items-center justify-center">
